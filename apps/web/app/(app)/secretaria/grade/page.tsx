...
import { useGradeAtiva, useGerarGrade } from "@/features/schedule/hooks/useSchedule";
import { GradeView } from "@/features/schedule/components/GradeView";

export default function SecretariaGradePage() {
  ...
  return (
    <div className="space-y-6 p-8">
      ...
      {isLoading ? (
        ...
        <p className="text-sm text-[var(--color-muted-foreground)]">Nenhuma grade publicada ainda.</p>
      )}
    </div>
  );
}
